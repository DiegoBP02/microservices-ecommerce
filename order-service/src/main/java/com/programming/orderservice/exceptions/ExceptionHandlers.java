...
public class ExceptionHandlers {
    ...
    public ResponseEntity<StandardError> ProductOutOfStockException
            (ProductOutOfStockException e, HttpServletRequest request) {
        log.error("Product out of stock exception: ", e);
        String error = "Product out of stock";
